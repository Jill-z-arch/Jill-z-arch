...
echo "[Info] LOG=/mnt/synology/wen.zhou/2026.05/Coordinate_Attention/logs_tmux/train_2026-01-24_004552.log"
...
python -u train_Coordinate_Attention.py \
  ...
  2>&1 | tee -a "/mnt/synology/wen.zhou/2026.05/Coordinate_Attention/logs_tmux/train_2026-01-24_004552.log" \
