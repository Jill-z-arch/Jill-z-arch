...
echo "[Info] LOG=/mnt/synology/wen.zhou/2026.05/Coordinate_Attention/logs_tmux/train_2026-01-24_010130.log"
echo "[Info] OUT=/mnt/synology/wen.zhou/2026.05/Coordinate_Attention/output"

python -u train_Coordinate_Attention.py \
  --image_root "/mnt/synology/wen.zhou/2026.01/dataset2" \
  ...
  --topk "1,2,4" \
  --pretrained \
  --output_dir "/mnt/synology/wen.zhou/2026.05/Coordinate_Attention/output" \
  --skip_broken \
  --use_coord_attn \
  --coord_reduction "32" \
  --use_agent_attn \
  ...
  2>&1 | tee -a "/mnt/synology/wen.zhou/2026.05/Coordinate_Attention/logs_tmux/train_2026-01-24_010130.log" \
